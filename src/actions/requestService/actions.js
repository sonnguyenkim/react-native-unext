...
// export const getUserListToBeRated = (currentUser) => dispatch => {
//   console.log('action-getUserListToBeRated',currentUser)
//   const firestore = firebase.firestore();
//   const requestRef = firestore.collection('requestService');
//   let ratingList = []
...
//     if (requestCollection.exists) {
//       console.log('action-requestCollection.exists')
//       requestRef.where('contactInfo','array-contains',currentUser.uid).get()
//       .then(docs => {
//         if (docs.exists) {
//           console.log('action-getUserListToBeRated-docs',docs)
//           docs.forEach(doc => {
//             const jobs = doc.data().jobs;
//             console.log('action-getUserListToBeRated-jobs',jobs)
//             const jobsLength = jobs.length;
//             for( let i=0; i<jobsLength; i++) {
//               let job = jobs[i]
//               if (currentUser.providerMode) { 
...
//                     userInfo: job.requestorInfo
//                   }
//                   console.log('action-getUserListToBeRated-info',info)
//                   ratingList.push(info)
...
//           });  
//         }
//         console.log('action-getUserListToBeRated-ratingList',ratingList)
//         dispatch(requestServiceListLoadedSuccessType(ratingList));
//       })
//       .catch(error => {
//         dispatch(requestServiceErrorType(error.message));
...
//         console.log('action-requestCollection.NOT exists')
