        ...
        .then(receiverDoc => {
          ...
          .then(doc => {
            if (doc.exists) {
              ...
              // console.log('senderDetail.unseenCount', senderDetail);
              ...
              .then(() => {
                // console.log('Update data: contactInfoDetail & message SUCCESSFULLY');
                // **************************************************
              ...
              .then(() => {
                // console.log('Add new Doc:  SUCCESSFULLY');
                // **************************************************
                dispatch(messageSentSuccess());
              })
              .catch(error => {
...
//               const conatct_0 = docContactInfoDetail[0];
//               const conatct_1 = docContactInfoDetail[1];
//               console.log('conatct_0',conatct_0);
//               console.log('conatct_1',conatct_1);
//               if (conatct_0.senderId === receiverDetail.currentId) {
//                 senderDetail.unseenCount = conatct_0.unseenCount + 1;
//                 // Update Receiver Info
//                 // receiverDetail.lastMessageTime = conatct_1.lastMessageTime;
//                 // receiverDetail.lastMessage = conatct_1.lastMessage;
//               } else {
//                 senderDetail.unseenCount = conatct_1.unseenCount + 1;    
//                 // Update Receiver Info 
//                 // receiverDetail.lastMessageTime = conatct_0.lastMessageTime;
//                 // receiverDetail.lastMessage = conatct_0.lastMessage;       
//               }
//               // console.log('senderDetail.unseenCount', senderDetail);
//               console.log('receiverDetail',receiverDetail);
...
export const loadConversationForContactId = (contactId) => dispatch => {
  // dispatch(messageLoading());
  // console.log('loadConversationForContactId-contactId', contactId);
  var messages = [];
  let currentUser = firebase.auth().currentUser;
  let currentId = currentUser.uid;
  let conversationId = '';
...
export const loadConversationForContactIdAffirmation = (contactId) => dispatch => {
  ...
  // console.log('loadConversationForContactIdAffirmation');
}
