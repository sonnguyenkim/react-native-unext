...
class MessageBoxScreen extends Component {
  ...
  render() {
    ...
    />
        <NavigationEvents
          onWillFocus={() => console.log('NavigationEvents-will focus')}
          onDidFocus={() => console.log('NavigationEvents-did focus')}
          onWillBlur={() => console.log('NavigationEvents-will blur')}
          onDidBlur={() => console.log('NavigationEvents-did blur')}
        />
                  ...
                  <Right>
                    <View style={{flexDirection: 'column', borderWidth: 0}}>
                      ...
                      :
                        <Button
                          transparent
                          onPress={() => this.addProviderToFavourite(user)} >
                          <Icon style={{ color: "green", fontSize: 25}} name="ios-heart-half" />
                          {/* <Icon style={{ color: "green", fontSize: 30}} name="ios-star-half" /> */}
                        </Button>
                      }
